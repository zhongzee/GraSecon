...
# Modified by Mingxuan Liu from https://github.com/clin1223/VLDet/blob/main/train_net.py
...
from vldet.evaluation.inateval import INATEvaluator
from vldet.evaluation.fsodeval import FSODEvaluator
import ssl
...
def do_test(cfg, model):
    ...
    for d, dataset_name in enumerate(cfg.DATASETS.TEST):
        ...
        if evaluator_type == "lvis" or cfg.GEN_PSEDO_LABELS:
            ...
            if dataset_name == 'coco_generalized_zeroshot_val' or 'coco_generalized_del_val':
        ...
        results[dataset_name] = inference_on_dataset_OIFC(
