...
#SBATCH --output=./slurm-output/coco_ovod_Detic_CLIP_Caption-image_R50_1x_GraSecon_llm.out
...
python train_net_detic_coco.py \
        --num-gpus 8 \
        --config-file ./configs_detic/coco/Detic_OVCOCO_CLIP_R50_1x_max-size_caption.yaml \
        --eval-only \
