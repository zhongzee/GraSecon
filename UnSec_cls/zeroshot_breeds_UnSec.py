...
def do_UnSec(args, aggr_method, model, dloader, class_tree, label_mapper):
    ...
    if args.breed_level == 'all':
        for level, tree in class_tree.items():
            ...
            print_results(f"UnSec_Mean_{args.model_size}_BREEDS_{level}", level_results)
    else:
        ...
        print_results(f"UnSec_Mean_{args.model_size}_BREEDS_{args.breed_level}", level_results)
...
if __name__ == '__main__':
  ...
  parser.add_argument('--hierarchy_root',
                      type=str,
                      default="./UnSec_cls/hrchy_breeds",
                      )
  ...
  parser.add_argument('--out_path', default='./nexus/imagenet2012/vitB32/hrchy_breeds') # UnSec_llm_by_level_TFC_0109_new_layer_policy_5n1g,UnSec_llm_by_level_TFC_0109_new_layer_policy_6g，UnSec_llm_by_level_TFC_0111_new_layer_policy_5n1g_w_SR_epoch100
  ...
  # UnSec
    ...
    UnSec_mean_results = do_UnSec(args, "mean", encoder, dloader, class_tree, label_mapper)

    # print_results(
    #   method=f"UnSec_Mean_{args.model_size}_BREEDS_{args.breed_level}", results=UnSec_mean_results
    # )
  else:
