...
#SCRIPT_PATH="./scripts_local/Detic/inat/swin/UnSec_llm/inat_detic_SwinB_LVIS-IN-21K-COCO_UnSec_llm_visuallize.sh"


#SCRIPT_PATH="./scripts_local/Detic/inat/swin/UnSec_gt/inat_detic_SwinB_LVIS-IN-21K-COCO_UnSec_gt_detail.sh"
#SCRIPT_PATH="./scripts_local/Detic/inat/swin/UnSec_gt/inat_detic_SwinB_LVIS-IN-21K_UnSec_gt_detail.sh"
SCRIPT_PATH="./scripts_local/Detic/inat/swin/UnSec_llm/inat_detic_SwinB_LVIS-IN-21K-COCO_UnSec_detail_llm_1028.sh"
#SCRIPT_PATH="./scripts_local/Detic/inat/swin/UnSec_gt/inat_detic_SwinB_LVIS_UnSec_gt_detail.sh"
...
#SCRIPT_PATH="./scripts_local/Detic/lvis/UnSec_llm/lvis_ovod_BoxSup_C2_Lbase_CLIP_R50_640_4x_UnSec_llm.sh"
# 获取脚本所在的目录
