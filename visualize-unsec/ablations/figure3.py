...
def plot_heatmap(data_dict, title, filename, show_colorbar=False):
    ...
    methods = ["GraSecon", "wo/SAS", "wo/MGC", "GraSecon"]
...
data_values_dict = {
    "L6": {
        "GraSecon": [74.0, 78.8, 84.5, 82.7],
        "wo/SAS": [74.9, 81.6, 85.3, 84.6],
        "wo/MGC": [75.4, 83.2, 85.7, 85.4],
        "GraSecon": [76.7, 84.5, 86.5, 86.0]
    },
    "L5": {
        "GraSecon": [68.4, 69.0, 76.3, 76.1],
        "wo/SAS": [71.9, 73.2, 80.2, 78.2],
        "wo/MGC": [72.6, 74.5, 81.4, 78.7],
        "GraSecon": [73.9, 78.8, 82.3, 80.5]
    },
    "L4": {
        "GraSecon": [73.7, 79.3, 84.0, 83.4],
        "wo/SAS": [74.8, 80.8, 84.9, 84.6],
        "wo/MGC": [75.5, 81.6, 85.5, 85.1],
        "GraSecon": [76.7, 82.9, 86.9, 85.7]
    },
    "L3": {
        "GraSecon": [73.2, 78.7, 83.6, 81.7],
        "wo/SAS": [74.5, 79.9, 84.3, 82.1],
        "wo/MGC": [74.8, 80.5, 84.8, 82.4],
        "GraSecon": [75.8, 81.2, 85.7, 82.8]
    },
    "L2": {
        "GraSecon": [62.8, 75.1, 77.2, 74.5],
        "wo/SAS": [62.9, 75.2, 77.4, 74.5],
        "wo/MGC": [62.9, 75.2, 77.5, 74.5],
        "GraSecon": [63.0, 75.3, 77.6, 74.6]
    },
    "L1": {
        "GraSecon": [50.7, 59.4, 63.8, 62.1],
        "wo/SAS": [50.7, 59.4, 64.9, 62.2],
        "wo/MGC": [50.7, 59.4, 65.2, 62.2],
        "GraSecon": [50.8, 59.5, 66.5, 62.3]
    }
}
