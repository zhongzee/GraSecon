...
# Modified by Mingxuan Liu from https://github.com/CVMI-Lab/CoDet/blob/main/train_net.py
...
from codet.evaluation.inateval import INATEvaluator
from codet.evaluation.fsodeval import FSODEvaluator
...
def do_test(cfg, model):
    ...
    for d, dataset_name in enumerate(cfg.DATASETS.TEST):
        ...
        output_folder = os.path.join(
            cfg.OUTPUT_DIR, "inference_{}_{}".format(dataset_name, cfg.MODEL.TEST_CLASSIFIERS[
                d]))  # Miu: added classifier name into output name
...
--num-gpus 1
--config-file ./configs_codet/CoDet_OVLVIS_SwinB_4x_ft4x.yaml
--eval-only
DATASETS.TEST "('inat_val_l1', 'inat_val_l2', 'inat_val_l3','inat_val_l4','inat_val_l5','inat_val_l6',)"
MODEL.WEIGHTS ./models/codet/CoDet_OVLVIS_SwinB_4x_ft4x.pth
MODEL.RESET_CLS_TESTS True
MODEL.TEST_CLASSIFIERS "('./nexus/inat/vitB32/GraSecon_llm/inat_clip_hrchy_l1.npy', './nexus/inat/vitB32/GraSecon_llm/inat_clip_hrchy_l2.npy', './nexus/inat/vitB32/GraSecon_llm/inat_clip_hrchy_l3.npy', './nexus/inat/vitB32/GraSecon_llm/inat_clip_hrchy_l4.npy', './nexus/inat/vitB32/GraSecon_llm/inat_clip_hrchy_l5.npy', './nexus/inat/vitB32/GraSecon_llm/inat_clip_hrchy_l6.npy', )"
...
--num-gpus 1
--config-file ./configs_codet/CoDet_OVLVIS_R5021k_4x_ft4x.yaml
--eval-only
DATASETS.TEST "('inat_val_l1', 'inat_val_l2', 'inat_val_l3','inat_val_l4','inat_val_l5','inat_val_l6',)"
MODEL.WEIGHTS ./models/codet/CoDet_OVLVIS_R5021k_4x_ft4x.pth
MODEL.RESET_CLS_TESTS True
MODEL.TEST_CLASSIFIERS "('./nexus/inat/vitB32/GraSecon_llm/inat_clip_hrchy_l1.npy', './nexus/inat/vitB32/GraSecon_llm/inat_clip_hrchy_l2.npy', './nexus/inat/vitB32/GraSecon_llm/inat_clip_hrchy_l3.npy', './nexus/inat/vitB32/GraSecon_llm/inat_clip_hrchy_l4.npy', './nexus/inat/vitB32/GraSecon_llm/inat_clip_hrchy_l5.npy', './nexus/inat/vitB32/GraSecon_llm/inat_clip_hrchy_l6.npy', )"
MODEL.TEST_NUM_CLASSES "(5, 18, 61, 184, 317, 500,)"
MODEL.MASK_ON False
