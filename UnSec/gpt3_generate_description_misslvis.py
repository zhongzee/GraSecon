...
parser.add_argument('--input_file', default='./UnSec/miss_lvis_oid_llm_answers', help='Input JSON directory containing hierarchical structure.')
parser.add_argument('--output_file', default='./UnSec/miss_lvis_oid_llm_answers', help='Output JSON directory to store the results.')
...
def check_missing_details(levels):
    ...
    for level in levels:
        input_file_path = os.path.join(args.output_file, f'./UnSec/miss_lvis_oid_llm_answers/cleaned_oid_lvis_gpt_detail_hrchy_l3.json')
