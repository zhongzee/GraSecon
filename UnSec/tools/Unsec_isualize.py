...
def visualize_feature_distribution_for_level(theme_tree_features_before, theme_tree_features_after, level_name, dataset_name, save_path=None):
    ...
    orin_color = 'blue'  # Darker blue (UnSec)
    ...
    ax.scatter(orin_reduced_features[:, 0], orin_reduced_features[:, 1], alpha=0.7, s=180, 
               label=f'{level_name} UnSec', color=orin_color)
...
# save_path = './nexus/inat/vitB32/UnSec_llm_by_level_TFC_0113_new_layer_policy_5n1g_new_epoch2_dgm_visualize'  # Specify the save path
...
# 例如：args.out_path = './nexus/inat/vitB32/UnSec_llm_by_level'
