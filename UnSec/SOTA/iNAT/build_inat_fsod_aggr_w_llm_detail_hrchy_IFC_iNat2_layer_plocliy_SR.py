...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_path', default='./nexus/inat/vitB32/UnSec_llm_by_level_TFC_0111_new_layer_policy_5n1g_w_SR_epoch1') # UnSec_llm_by_level_TFC_0109_new_layer_policy_5n1g,UnSec_llm_by_level_TFC_0109_new_layer_policy_6g
    ...
    parser.add_argument('--enable_global_mean', action='store_true', default=False, help='是否开启多领域总体均值校正') # 使用原本的修正方式前5层不需要开启gm第6层需要,使用最新的一直需要开启
    ...
    for level_name in level_names:
        ...
        for cat_id, entry in gpt_results.items():
            ...
            if args.optimizer == 'adm':
                ...
                optimized_feature= optimize_feature_with_adm_improved2(
