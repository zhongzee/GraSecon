...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_path', default='./nexus/inat/vitB32/UnSec_llm_by_level_TFC_0109_new_layer_policy_5g1n') # UnSec_llm_by_level_TFC_0109_new_layer_policy_5n1g,UnSec_llm_by_level_TFC_0109_new_layer_policy_6g
   ...
   # 创建嵌套的类别名称到ID的映射
    ...
    # 修正领域偏置 UnSec_llm_by_level_TFC_0108_orin
    # for level_name, level_data in theme_tree_features.items():
