...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_path', default='./nexus/inat/vitB32/UnSec_llm_IFC_1226')
    ...
    text_calculator = TextMeanFeatureCalculator2(save_dir='./nexus/inat/vitB32/UnSec_llm_IFC_1226',device=device)
