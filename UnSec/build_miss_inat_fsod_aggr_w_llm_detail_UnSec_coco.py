...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_name', default='coco', choices=['inat_expanded',
                                                                                         'fsod_expanded',
                                                                                         'coco', 'lvis', 'oid'])
    parser.add_argument('--gpt_results_root', default='./UnSec/coco_llm_answers')
    ...
    parser.add_argument('--out_path', default='./nexus/coco/vitB32/UnSec_llm_detail_unsec')#UnSec_llm_detail_unsec_epoch1,UnSec_llm_detail_unsec_wo_SR
