...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_name', default='fsod_expanded', choices=['inat_expanded',
                                                                                         'fsod_expanded',
                                                                                         'coco', 'lvis', 'oid'])
    parser.add_argument('--gpt_results_root', default='./GraSecon/fsod_llm_detail_answers')
    ...
    parser.add_argument('--out_path', default='./nexus/fsod_miss/vitB32/GraSecon_llm_detail_GraSecon')#GraSecon_llm_detail_GraSecon_epoch1,GraSecon_llm_detail_GraSecon_wo_SR
