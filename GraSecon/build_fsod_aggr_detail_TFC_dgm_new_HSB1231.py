...
if __name__ == '__main__':
    ...
    parser.add_argument('--tree', default='./GraSecon/fsod_annotations/fsod_hierarchy_tree.json')
    ...
    parser.add_argument('--out_path', default='./nexus/fsod/vitB32/GraSecon_GT_detail_TFC_nggm_rHSB_1231')
    ...
    hierarchy_dir = "./GraSecon/fsod_llm_detail_answers/"
