...
parser.add_argument('--input_file', default='./GraSecon_cls/hrchy_imagenet1k', help='Input JSON directory containing hierarchical structure.')
parser.add_argument('--output_file', default='./GraSecon_cls/hrchy_imagenet1k', help='Output JSON directory to store the results.')
