...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_path', default='.././nexus/inat_miss/vitB32/GraSecon_llm_detail')
    ...
    if args.dataset_name in ["inat_expanded", "fsod_expanded"]:
        ...
        for level_name in level_names[:1]:
            ...
            expanded_results = load_json(f"miss_lvis_oid_llm_answers/cleaned_oid_lvis_gpt_detail_hrchy_{level_name}.json")
