...
if __name__ == '__main__':
    ...
    parser.add_argument('--gpt_results_root', default='./GraSecon/inat_llm_detail_answers')
    ...
    parser.add_argument('--out_path', default='./nexus/inat/vitB32/GraSecon_llm_detail_1220')
