...
parser.add_argument('--output_file', default='fsod_llm_detail_answers', help='Output JSON directory to store the results.')
parser.add_argument('--level', nargs='+', default=['all'], choices=['l1', 'l2', 'l3', 'l4', 'l5', 'l6', 'all'], help='Specify which level(s) (l1-l6) or all levels to process.')
