...
if __name__ == '__main__':
    ...
    parser.add_argument('--tree', default='./GraSecon/inat_annotations/inat_hierarchy_tree.json')
    ...
    parser.add_argument('--out_path', default='./nexus/inat/vitB32/GraSecon_GT_TFC')
