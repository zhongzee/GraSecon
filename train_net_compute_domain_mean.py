...
from detic.modeling.utils import reset_cls_test,reset_cls_test_coco
...
def custom_argument_parser():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to an additional scripts file (custom argument)"
    )
    return parser
...
# def parse_args():
#     parser = argparse.ArgumentParser(description="Detectron2 Training/Testing Script")
#     parser.add_argument("--num-gpus", type=int, default=1, help="Number of GPUs to use")
#     parser.add_argument("--config-file", type=str, required=True, help="Path to the config file")
#     parser.add_argument("--eval-only", action="store_true", help="Perform evaluation only")
#     parser.add_argument("--scripts-file", type=str, default=None, help="Path to scripts file")
#     parser.add_argument("opts", nargs="*", help="Additional options")
