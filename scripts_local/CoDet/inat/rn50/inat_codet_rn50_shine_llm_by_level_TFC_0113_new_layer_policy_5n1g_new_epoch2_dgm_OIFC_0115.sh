...
METADATA_ROOT="./nexus/inat/vitB32/UnSec_llm_by_level_TFC_0113_new_layer_policy_5n1g_new_epoch2_dgm"

python train_net_codet_OIFC.py \
       --num-gpus 8 \
       --config-file ${CFG_R50} \
       --eval-only \
...
#         --config-file ${CFG_R50} \
#         --eval-only \
#         DATASETS.TEST "('inat_val_l5','inat_val_l6',)" \
#         MODEL.WEIGHTS ${MODEL_R50} \
#         MODEL.RESET_CLS_TESTS True \
