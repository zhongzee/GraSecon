...
METADATA_ROOT="./nexus/inat/vitB32/GraSecon_llm_detail_bylevel"
...
python train_net_detic.py \
        ...
        MODEL.WEIGHTS ./GraSecon/modelsGraSecon_llm_detail_context/detic/cross_eval/Detic_LCOCOI21k_CLIP_SwinB_896b32_4x_ft4x_max-size.pth \
